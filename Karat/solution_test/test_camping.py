"""Solution tests for the camping-trip exercises."""

import unittest

from solutions.camping import carpool, shopping_savings


class ShoppingSavingsTest(unittest.TestCase):
    products = [
        ["Cheese", "Dairy"], ["Carrots", "Produce"], ["Potatoes", "Produce"],
        ["Canned Tuna", "Pantry"], ["Romaine Lettuce", "Produce"],
        ["Chocolate Milk", "Dairy"], ["Flour", "Pantry"],
        ["Iceberg Lettuce", "Produce"], ["Coffee", "Pantry"],
