"""Solution tests for choose-your-own-adventure ending exercises."""

import unittest

from solutions.book_endings import find_good_story_endings, find_story_ending
...
class GoodStoryEndingsTest(unittest.TestCase):
    ...
    def test_finds_reachable_good_ending(self):
        self.assertEqual(
            [25], find_good_story_endings(self.good, self.bad, [[3, 16, 24]])
        )
    ...
    def test_handles_loops_and_no_choices(self):
        ...
        self.assertEqual(
            ...
            find_good_story_endings(
                self.good, self.bad, [[3, 2, 19], [20, 21, 34]]
            ),
        )
        self.assertEqual(
            [10], find_good_story_endings(self.good, self.bad, [])
        )
