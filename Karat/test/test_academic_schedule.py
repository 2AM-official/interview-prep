"""Tests for the two-part Academic Schedule interview question.

Part 1 finds the courses shared by every unordered pair of students.
Part 2 finds every possible midpoint of a root-to-leaf curriculum track.

The starter implementations live in ``academic_schedule.py``.
"""

import unittest

from exercise.academic_schedule import curriculum_midpoints, find_pairs
...
class AcademicSchedulePart2Test(unittest.TestCase):
    def test_branching_curriculum(self):
        ...
        self.assertEqual(
            ...
            set(curriculum_midpoints(all_courses)),
        )
